...
基礎
- [x] [[30_程式語言/note/Java 基础常见面试题总结 (上)]]
- [x] [[Java 基础常见面试题总结 (中)]]
- [x] [[Java 基础常见面试题总结 (下)]]
- [x] [[Java 值传递详解]]
- [x] [[Java 序列化详解]]
...
- [x] [大厂面试第4季：尚硅谷Java面试题第4季，最新大厂java面试真题](https://www.bilibili.com/video/BV13T421k794/?spm_id_from=333.788.comment.all.click)
	...
	- note: [GitHub - re4388/course\_java\_interview\_seaso「」n4](https://github.com/re4388/course_java_interview_season4)
...
- [ ] [[mysql_idx#宋红康】MySQL数据库（入门到高级，菜鸟到大牛]]
